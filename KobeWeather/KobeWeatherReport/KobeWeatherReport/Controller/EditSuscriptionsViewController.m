//
//  EditSuscriptionsViewController.m
//  KobeWeatherReport
//
...
- (void)viewDidLoad {
    ...
    app.mainVC.navigationController.navigationBar.translucent = NO;
   // app.mainVC.navigationController.navigationBar.hidden = YES;
    app.mainVC.navigationController.navigationBar.backgroundColor = [UIColor clearColor];
